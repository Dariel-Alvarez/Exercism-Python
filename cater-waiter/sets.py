...
def tag_special_ingredients(dish):
    ...
    """
    special_ingredients_in_dish = set(dish[1]) & SPECIAL_INGREDIENTS
    return (dish[0], special_ingredients_in_dish)
...
def compile_ingredients(dishes):
    ...
    for dish in dishes:
        set_of_ingredients = set_of_ingredients.union(dish)
...
def singleton_ingredients(dishes, intersection):
    ...
    singleton = set()
    for dish in dishes:
        singleton = singleton.symmetric_difference(dish)
